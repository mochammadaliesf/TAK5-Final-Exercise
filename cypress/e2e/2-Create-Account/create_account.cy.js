...
describe('Customer new account', () => {
  ...
  //TC04
    it('Email already registered - Failed',() => {
      cy.input('Budi', 'Hartono', 'budihartono12@gmail.com', 'Budi123@', 'Budi123@' )
      cy.buttonclick()
  ...
  //TC05
    it('Input "Password, confirm password" with numeric & special character - Failed',() => {
      cy.input('Budi', 'Hartono', 'budihartono12@gmail.com', '12345678@', '12345678@' )
      cy.buttonclick()
  ...
  //TC06
    it('Confirm Password different from password  - Failed',() => {
      cy.input('Budi', 'Hartono','budihartono12@gmail.com', 'Budi123@', 'Budi1234@')
